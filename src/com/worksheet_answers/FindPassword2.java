...
public class FindPassword2 {
	...
	public int findPasswordTwo(int input1, int input2, int input3, int input4, int input5) {
	...
	public static void main(String args[]) {
		FindPassword2 a2 = new FindPassword2();
		...
		input4=scan.nextInt();
		input5=scan.nextInt();
		int result = a2.findPasswordTwo(input1,input2,input3,input4,input5);
